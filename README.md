...
Light and Dark theme for Zed ported from https://github.com/tonsky/sublime-scheme-alabaster.
...
![screenshot of Zed using Alabaster theme](./screenshot-alabaster.png)

![screenshot of Zed using Alabaster Dark theme](./screenshot-alabaster-dark.png)

## Credits

- [Original Alabaster Theme](https://github.com/tonsky/sublime-scheme-alabaster)
- [Alabaster for VSCode](https://github.com/tonsky/vscode-theme-alabaster)
